...
<body>
    <div class="wrap">
        <div class="container">
            <form>
                <h1 style="color: white; margin: 0; text-align: center">reFindPassward</h1>
                <label><input type="text" placeholder="Your username" /></label>
                <label><input type="text" placeholder="Your email" /></label>
                <label><input type="text" placeholder="The Vertification code" /></label>
                ...
                <label><input type="password" placeholder="Please confirm your password" /></label>
                            ...
                            <p class="change_link" style="text-align: center">
                                    ...
                                    <a href="SignIn.jsp" class="to_login">Return to signIn </a>
                                </p>
            </form>
        </div>
            <ul>
